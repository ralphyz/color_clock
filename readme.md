...
## Web Server
Once the pi reboots, you should be able to browse to the web server in any browser on your network.  From there, you can touch a LED to enable that color.  When a color is enabled and it is not the scheduled time for that color, the "Temporary Override" button will turn on.  You can click it off, or you can select a different LED.  
